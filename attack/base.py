...
class TrainBase(object):
    ...
    def run(self):
        ...
        # else:
        #     self.test()
        # if self.args.is_attack or self.args.is_target:
        self.attack()
    ...
    def save_model(self, epoch):
        torch.save(self.model.state_dict(), os.path.join(self.args.save_dir, str(self.args.dataset) + str(self.args.output_dim) + "-model-" + str(epoch) + ".pth"))
        self.logger.info("save mode to {}".format(os.path.join(self.args.save_dir, str(self.args.dataset) + str(self.args.output_dim) + "-model-" + str(epoch) + ".pth")))
    ...
    def attack(self):
        raise NotImplementedError("Function of 'attack' doesn't implement.")
