...
if __name__ == "__main__":
    ...
    parser.add_argument("--coco-dir", default="/home/fun/deeplearning/dataset/MSCOCO2017/", type=str, help="the coco dataset dir")
    parser.add_argument("--save-dir", default="/home/fun/deeplearning/dataset/MSCOCO2017/", type=str, help="mat file saved dir")
    args = parser.parse_args()
    
    
    PATH = args.coco_dir
    jsonFile = os.path.join(PATH, "annotations_trainval2017/annotations", "captions_train2017.json")
    ...
    # print(result)
    jsonFile = os.path.join(PATH, "annotations_trainval2017/annotations", "instances_train2017.json")
    with open(jsonFile, "r") as f:
        jsonData = json.load(f)
    categroy_ids = {}
    ...
    val_jsonFile = os.path.join(PATH, "annotations_trainval2017/annotations", "captions_val2017.json")
    ...
    jsonFile = os.path.join(PATH, "annotations_trainval2017/annotations", "instances_val2017.json")
    with open(jsonFile, "r") as f:
        jsonData = json.load(f)
    categroy_ids = {}
    for i, item in enumerate(jsonData['categories']):
